...
- the western way of doing this seems to be with pimoroni's inky line of e-ink displays. they are not as based, and pi-only, and have a python library. they are probably easier to set up.
